...
class GFG { 
    ...
    { 
        ...
        System.out.println("String1==> " + Arrays.toString(count1));
        System.out.println("String2==> " + Arrays.toString(count2));
    ...
    { 
        String str1 = "fcrxzwscanmligyxyvym", str2 = "jxwtrhvujlmrpdoqbisbwhmgpmeoke"; 
